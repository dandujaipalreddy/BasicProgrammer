...
public class IgniteTest implements Serializable {
    ...
    private static Logger logger = Logger.getLogger(IgniteTest.class);
    private static IgniteTest cacheCreation;

    private IgniteTest() {

    }

    public static IgniteTest getInstance() {
        if (cacheCreation == null)
            cacheCreation = new IgniteTest();
